...
DOMAIN_NAME="future-ai.me" # replace with your own
EMAIL="jonas.tischer@gmail.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/jonastischer/next-self-host.git"
APP_DIR=~/myapp
